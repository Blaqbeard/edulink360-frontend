...
function TeacherSettings() {
  ...
  const fetchSettings = async () => {
    try {
      ...
      if (response.data) {
        ...
        setShowProfile(response.data.showProfile !== undefined ? response.data.showProfile : true);
        setPerformanceAnalytics(response.data.performanceAnalytics !== undefined ? response.data.performanceAnalytics : true);
      }
    } catch (error) {
  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      ...
      <div className={`fixed left-0 top-0 w-64 bg-[#0b1633] flex flex-col h-screen z-40 transition-transform duration-300 ${
        ...
        <div className="p-4 space-y-2 border-t border-white/10">
          ...
          <a
            href="#"
            className="flex items-center gap-3 px-4 py-3 bg-[#0D4A56] rounded-lg text-white transition-all duration-200"
          >
      ...
      <div className="flex-1 flex flex-col overflow-y-auto md:ml-64">
        ...
        <main className="flex-1 p-4 sm:p-6 md:p-8 space-y-6">
          ...
          <div className="animate-[fadeInUp_0.6s_ease-out_0.1s_both]">
            ...
            <h2 className="text-3xl font-bold text-[#0b1633] mb-2">Settings</h2>
            <p className="text-sm text-[#0b1633]">
              Manage your account preferences and settings
            </p>
          </div>

          {/* Email Address Card */}
          <div className="bg-white rounded-lg p-6 shadow-sm animate-[fadeInUp_0.6s_ease-out_0.2s_both]">
            <label className="block text-sm font-medium text-black mb-2">
              Email Address
            </label>
            <input
              type="email"
              value="adewale.aina@edulink360.com"
              readOnly
              className="w-full px-4 py-2 bg-gray-100 border border-gray-200 rounded-lg text-gray-500 cursor-not-allowed focus:outline-none"
            />
          </div>
          ...
          <div className="animate-[fadeInUp_0.6s_ease-out_0.3s_both]">
            <a
              ...
              onClick={(e) => {
                e.preventDefault();
                alert("Coming soon: Password change functionality will be available in the next update.");
              }}
          ...
          <div className="flex items-center justify-between animate-[fadeInUp_0.6s_ease-out_0.4s_both]">
            <div>
            ...
            <button 
              onClick={() => alert("Coming soon: Two-factor authentication will be available in the next update.")}
              className="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors text-sm font-medium cursor-not-allowed opacity-50"
              disabled
            >
              Enable
            </button>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm animate-[fadeInUp_0.6s_ease-out_0.5s_both]">
            ...
            <p className="text-sm text-gray-700 mb-6">
              Control how you stay updated with your teaching activities
            </p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between py-3 border-b border-gray-100">
                ...
                <button
                  onClick={() => toggleNotification("submissionAlert")}
                  className={`relative w-12 h-6 rounded-full transition-colors duration-300 ${
                    notifications.submissionAlert
                      ? "bg-[#0b1633]"
                      : "bg-gray-300"
                  }`}
                >
              ...
              <div className="flex items-center justify-between py-3 border-b border-gray-100">
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-700 mt-1">
                    Receive alerts for pending feedback requests
                  </p>
                </div>
                <button
                  onClick={() => toggleNotification("feedbackRequests")}
                  className={`relative w-12 h-6 rounded-full transition-colors duration-300 ${
              ...
              <div className="flex items-center justify-between py-3 border-b border-gray-100">
                ...
                <button
                  onClick={() => toggleNotification("messageNotification")}
                  className={`relative w-12 h-6 rounded-full transition-colors duration-300 ${
              ...
              <div className="flex items-center justify-between py-3">
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-700 mt-1">
                    Reminders for upcoming grading deadlines
                  </p>
                </div>
                <button
                  onClick={() => toggleNotification("gradeDeadline")}
                  className={`relative w-12 h-6 rounded-full transition-colors duration-300 ${
                    notifications.gradeDeadline ? "bg-[#0b1633]" : "bg-gray-300"
                  }`}
                >
                  <span
                    className={`absolute top-1 left-1 w-4 h-4 bg-white rounded-full transition-transform duration-300 ${
                      notifications.gradeDeadline
                        ? "translate-x-6"
                        : "translate-x-0"
                    }`}
                  ></span>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm animate-[fadeInUp_0.6s_ease-out_0.6s_both]">
            <h2 className="text-xl font-bold text-gray-900 mb-2">
              Privacy and Accessibility
            </h2>
            <p className="text-sm text-gray-700 mb-6">
              Make your teaching space feel like you
            </p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between py-3">
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-700 mt-1">
                    Allow students view your profile details
                  </p>
                </div>
                <button
                  onClick={() => setShowProfile(!showProfile)}
                  className={`relative w-12 h-6 rounded-full transition-colors duration-300 ${
                    showProfile ? "bg-[#0b1633]" : "bg-gray-300"
                  }`}
                >
                  <span
                    className={`absolute top-1 left-1 w-4 h-4 bg-white rounded-full transition-transform duration-300 ${
                      showProfile ? "translate-x-6" : "translate-x-0"
                    }`}
                  ></span>
                </button>
              </div>
              ...
              <div className="flex items-center justify-between py-3">
                ...
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    alert("Coming soon: Data sharing management will be available in the next update.");
                  }}
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm animate-[fadeInUp_0.6s_ease-out_0.7s_both]">
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between py-3 border-b border-gray-100">
                ...
                <button
                  onClick={() => setPerformanceAnalytics(!performanceAnalytics)}
                  className={`relative w-12 h-6 rounded-full transition-colors duration-300 ${
                    performanceAnalytics ? "bg-[#0b1633]" : "bg-gray-300"
                  }`}
                >
                  <span
                    className={`absolute top-1 left-1 w-4 h-4 bg-white rounded-full transition-transform duration-300 ${
                      performanceAnalytics ? "translate-x-6" : "translate-x-0"
                    }`}
                  ></span>
                </button>
              </div>
              ...
              <div className="flex items-center justify-between py-3 border-b border-gray-100">
                ...
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    alert("Coming soon: Grading template management will be available in the next update.");
                  }}
                  className="text-blue-500 text-sm font-medium hover:underline"
                >
                  Manage
              ...
              <div className="flex items-center justify-between py-3">
                ...
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    alert("Coming soon: Office hour settings will be available in the next update.");
                  }}
                  className="text-blue-500 text-sm font-medium hover:underline"
                >
                  Manage
          ...
          {/* Save Button */}
          <div className="flex justify-end animate-[fadeInUp_0.6s_ease-out_0.8s_both]">
            <button
              onClick={handleSaveSettings}
              disabled={saving || loading}
              className="px-6 py-3 bg-[#0b1633] text-white rounded-lg font-medium hover:bg-[#1A2332] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          {/* Bottom Actions */}
          <div className="flex flex-col sm:flex-row gap-4 animate-[fadeInUp_0.6s_ease-out_0.9s_both]">
            <a
              href="#"
              onClick={(e) => {
                e.preventDefault();
                alert("Coming soon: Account deactivation will be available in the next update.");
              }}
            ...
            <a
              ...
              onClick={(e) => {
                e.preventDefault();
                alert("Coming soon: Account deletion will be available in the next update.");
              }}
              className="text-red-700 text-sm font-medium hover:underline"
            >
              Delete Account
