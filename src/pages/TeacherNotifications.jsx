        ...
        <main className="flex-1 p-8">
              ...
              {notifications.map((notification, index) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    {/* Icon */}
                    <div
                      className={`w-12 h-12 ${notification.color} rounded-full flex items-center justify-center shrink-0`}
                    >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1">
                          <h3
                            className={`font-semibold text-gray-900 mb-1 ${
                              notification.unread ? "" : "text-gray-600"
                            }`}
                          >
                            {notification.title}
                          </h3>
                        ...
                        {notification.unread && (
                          <div className="w-2 h-2 bg-[#00B4D8] rounded-full shrink-0 mt-2"></div>
                        )}
                      </div>
                    </div>
                  </div>
          ...
          {notifications.length === 0 && (
            <div className="flex flex-col items-center justify-center h-96 text-gray-500">
              <i className="bi bi-bell-slash text-6xl mb-4"></i>
