...
function TeacherAssignments() {
    ...
    try {
      ...
      try {
        ...
        if (!Array.isArray(allSubmissions)) {
          allSubmissions =
            allSubmissions?.submissions || allSubmissions?.data || [];
        }
  ...
  const handleSelectAssignment = async (assignment) => {
    ...
    if (assignment.id) {
      try {
        ...
        const details = await teacherService.getAssignmentDetails(
          assignment.id
        );
  ...
  const handleSubmitFeedback = async (e) => {
    ...
    try {
      ...
      await teacherService.sendAssignmentFeedback(
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center h-64 text-gray-500">
              ...
              <p className="text-lg font-medium">
                No assignments with submissions yet
              </p>
              <p className="text-sm mt-2 text-center max-w-md">
                Create assignments from the dashboard. Submissions will appear
                here once students submit their work.
              </p>
              <button
