...
function Signup() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#283447] flex-col justify-between p-6 animate-[fadeInLeft_0.6s_ease-out]">
        {/* Logo */}
        <div className="flex items-center animate-[fadeInDown_0.8s_ease-out]">
        ...
        {/* Copyright */}
        <div className="text-white/60 text-xs animate-[fadeIn_0.8s_ease-out_0.7s_both]">
